...
const AddDiseaseSection = ({ type, onDiseaseAdded }: AddDiseaseSectionProps) => {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted/20 mb-12">
      ...
      <div className="w-full h-8 flex items-end justify-center overflow-hidden -mt-4">
        <div className="w-3/4 h-6 rounded-b-full bg-gradient-to-b from-blue-200/30 via-blue-400/10 to-transparent blur-2xl mx-auto"></div>
      </div>
    </>
  );
};
